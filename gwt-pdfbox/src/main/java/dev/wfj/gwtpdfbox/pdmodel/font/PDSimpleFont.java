...
public abstract class PDSimpleFont extends PDFont
{
    ...
    protected void readEncoding() throws IOException
    {
        ...
        if (encodingBase instanceof COSName)
        {
            ...
            {
                DomGlobal.console.warn("Unknown encoding: " + encodingName.getName());
    ...
    public String toUnicode(int code, GlyphList customGlyphList)
    {
        ...
        if (/*DomGlobal.console.isWarnEnabled() && */!noUnicode.contains(code))
        {
            ...
            if (name != null)
            {
                DomGlobal.console.warn("No Unicode mapping for " + name + " (" + code + ") in font " +
                        getName());
            }
            else
            {
                DomGlobal.console.warn("No Unicode mapping for character code " + code + " in font " +
                        getName());
            }
        }
