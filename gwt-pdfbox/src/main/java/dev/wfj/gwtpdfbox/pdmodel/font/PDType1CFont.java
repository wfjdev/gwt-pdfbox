...
public class PDType1CFont extends PDSimpleFont implements PDVectorFont
{
        ...
        if (fd != null)
        {
            ...
            if (ff3Stream != null)
            {
                        ...
                        .createView())
                {
                    ...
                    {
                        DomGlobal.console.error("Invalid data for embedded Type1C font " + getName());
                    }
                    else
                    {
                        ...
                        {
                            DomGlobal.console.error("Expected CFFType1Font, got "
                ...
                {
                    DomGlobal.console.error("Can't read the embedded Type1C font " + getName(), e);
                    fontIsDamaged = true;
                }
            }
        }
    ...
    public float getHeight(int code) throws IOException
    {
        ...
        if (!glyphHeights.containsKey(name))
        {
            if (cffFont == null)
            {
                DomGlobal.console.warn("No embedded CFF font, returning 0");
                return 0;
            }
