...
public class PDDocument implements Closeable
{
    ...
    /*static
    {
        ...
        {
            DomGlobal.console.debug("voodoo error", ex);
        }
    }*/
   ...
   // private PDEncryption encryption;
    ...
    public PDPage importPage(PDPage page) throws IOException
    {
        ...
        {
            DomGlobal.console.warn("inherited resources of source document are not imported to destination page");
            DomGlobal.console.warn("call importedPage.setResources(page.getResources()) to do this");
        }
        return importedPage;
    }
     ...
     * In PDF 2.0 this is deprecated except for two entries, /CreationDate and /ModDate. For any other
     * document level metadata, a metadata stream should be used instead, see
     * {@link PDDocumentCatalog#setMetadata(dev.wfj.gwtpdfbox.pdmodel.common.PDMetadata) PDDocumentCatalog#setMetadata(PDMetadata)}.
     *
    ...
    /**
     * This will get the document CATADomGlobal.console. This is guaranteed to not return null.
     * 
     ...
     * <p>
     * If encryption has been activated (with {@link #protect(dev.wfj.gwtpdfbox.pdmodel.encryption.ProtectionPolicy)
     ...
     *
     * @see dev.wfj.gwtpdfbox.pdmodel.encryption.StandardProtectionPolicy
     * @see dev.wfj.gwtpdfbox.pdmodel.encryption.PublicKeyProtectionPolicy
     *
    ...
    /*public void protect(ProtectionPolicy policy) throws IOException
    {
        ...
        {
            DomGlobal.console.warn("do not call setAllSecurityToBeRemoved(true) before calling protect(), "
    ...
    public float getVersion()
    {
        ...
        if (headerVersionFloat >= 1.4f)
        {
            ...
            if (catalogVersion != null)
            {
                ...
                {
                    DomGlobal.console.error("Can't extract the version number of the document catalog.", exception);
                }
            }
    ...
    public void setVersion(float newVersion)
    {
        ...
        {
            DomGlobal.console.error("It's not allowed to downgrade the version of a pdf.");
            return;
        }
