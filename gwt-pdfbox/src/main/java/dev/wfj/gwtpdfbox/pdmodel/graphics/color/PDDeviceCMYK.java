 ...
 */
package dev.wfj.gwtpdfbox.pdmodel.graphics.color;

import java.util.Arrays;

import dev.wfj.gwtpdfbox.cos.COSName;

//import java.awt.color.ColorSpace;import java.awt.color.ICC_ColorSpace;
...
public class PDDeviceCMYK extends PDDeviceColorSpace
{
    ...
    protected void init() throws IOException
    {
        ...
        synchronized (this)
        {
            ...
            usePureJavaCMYKConversion = System
                    .getProperty("dev.wfj.gwtpdfbox.rendering.UsePureJavaCMYKConversion") != null;
    ...
    /* protected ICC_Profile getICCProfile() throws IOException
    {
        ...
        String resourceName = "/dev.wfj.gwtpdfbox/resources/icc/ISOcoated_v2_300_bas.icc";
    ...
    public float[] toRGB(float[] value)
    {
        ...
        return null;//awtColorSpace.toRGB(value);
    }
