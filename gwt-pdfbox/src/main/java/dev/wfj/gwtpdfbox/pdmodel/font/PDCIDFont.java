    ...
    private void readWidths()
    {
        ...
        if (wArray != null)
        {
            ...
            while (counter < size - 1)
            {
                ...
                {
                    DomGlobal.console.warn("Expected a number array member, got " + firstCodeBase);
                    continue;
                }
                ...
                if (next instanceof COSArray)
                {
                    ...
                    for (int i = 0; i < arraySize; i++)
                    {
                        ...
                        {
                            DomGlobal.console.warn("Expected a number array member, got " + widthBase);
                        }
                    }
                }
                else
                {
                    if (counter >= size)
                    {
                        DomGlobal.console.warn("premature end of widths array");
                        break;
                    }
                    ...
                    {
                        DomGlobal.console.warn("Expected two numbers, got " + secondCodeBase + " and " + rangeWidthBase);
                        continue;
                    }
