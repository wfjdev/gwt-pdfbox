...
import dev.wfj.gwtpdfbox.contentstream.PDContentStream;
...
import dev.wfj.gwtpdfbox.io.SequenceRandomAccessRead;
...
import dev.wfj.gwtpdfbox.pdmodel.interactive.action.PDPageAdditionalActions;
import dev.wfj.gwtpdfbox.pdmodel.interactive.measurement.PDViewportDictionary;
import dev.wfj.gwtpdfbox.pdmodel.interactive.pagenavigation.PDThreadBead;
import dev.wfj.gwtpdfbox.pdmodel.interactive.pagenavigation.PDTransition;
...
public class PDPage implements COSObjectable, PDContentStream
{
    ...
    public PDRectangle getMediaBox()
    {
        if (mediaBox == null)
        {
            ...
            {
                DomGlobal.console.debug("Can't find MediaBox, will use U.S. Letter");
    ...
    public List<PDViewportDictionary> getViewports()
    {
        ...
        for (int i = 0; i < array.size(); ++i)
        {
            ...
            {
                DomGlobal.console.warn("Array element " + base2 + " is skipped, must be a (viewport) dictionary");
            }
        }
        return viewports;
    }
