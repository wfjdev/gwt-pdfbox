 ...
 */
package dev.wfj.gwtpdfbox.pdmodel.interactive.documentnavigation.destination;
...
public abstract class PDPageDestination extends PDDestination
{
     ...
     *
     * @see dev.wfj.gwtpdfbox.pdmodel.interactive.documentnavigation.outline.PDOutlineItem
