...
public final class PDType3CharProc implements COSObjectable, PDContentStream
{
    ...
    public PDResources getResources()
    {
        ...
        {
            // PDFBOX-5294
            DomGlobal.console.warn("Using resources dictionary found in charproc entry");
            DomGlobal.console.warn("This should have been in the font or in the page dictionary");
