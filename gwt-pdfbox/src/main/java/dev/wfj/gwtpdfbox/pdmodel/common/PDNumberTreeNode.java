...
public class PDNumberTreeNode implements COSObjectable
{
    ...
    public Object getValue(Integer index) throws IOException
    {
        ...
        {
            DomGlobal.console.warn("NumberTreeNode does not have \"nums\" nor \"kids\" objects.");
        }
        return retval;
    }
    ...
    public Map<Integer,COSObjectable> getNumbers()  throws IOException
    {
        ...
        if (numbersArray != null)
        {
            ...
            {
                DomGlobal.console.warn("Numbers array has odd size: " + numbersArray.size());
            }
            for (int i = 0; i + 1 < numbersArray.size(); i += 2)
            {
                ...
                {
                    DomGlobal.console.error("page labels ignored, index " + i + " should be a number, but is " + base);
                    return null;
                }
    ...
    protected COSObjectable convertCOSToPD(COSBase base) throws IOException
    {
        ...
        throw new IOException("Error at convertCOSToPD");
    }
