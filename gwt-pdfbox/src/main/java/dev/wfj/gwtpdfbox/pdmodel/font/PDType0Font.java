...
public class PDType0Font extends PDFont implements PDVectorFont
{
    ...
    private void readEncoding() throws IOException
    {
        ...
        else if (encoding != null)
        {
            ...
            {
                DomGlobal.console.warn("Invalid Encoding CMap in font " + getName());
            }
        }
    ...
    public String toUnicode(int code)
    {
        ...
        if (descendantFont instanceof PDCIDFontType2)
        {
            ...
            if (font != null)
            {
                ...
                {
                    DomGlobal.console.warn("get unicode from font cmap fail", e);
                }
            }
        }
        ...
        if (/* DomGlobal.console.isWarnEnabled() &&  */!noUnicode.contains(code))
        {
            ...
            DomGlobal.console.warn("No Unicode mapping for " + cid + " (" + code + ") in font " + getName());
