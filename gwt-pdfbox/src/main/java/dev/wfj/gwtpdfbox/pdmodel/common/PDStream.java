...
import dev.wfj.gwtpdfbox.cos.COSInputStream;
...
import dev.wfj.gwtpdfbox.pdmodel.common.filespecification.PDFileSpecification;
    ...
    private List<Object> internalGetDecodeParams(COSName name1, COSName name2) throws IOException
    {
        ...
        if (dp instanceof COSArray)
        {
            ...
            for (int i = 0; i < array.size(); i++)
            {
                ...
                {
                    DomGlobal.console.warn("Expected COSDictionary, got " + base + ", ignored");
                }
            }
