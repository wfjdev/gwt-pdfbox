...
import dev.wfj.gwtpdfbox.pdmodel.common.COSArrayList;
import dev.wfj.gwtpdfbox.pdmodel.common.COSObjectable;
import dev.wfj.gwtpdfbox.pdmodel.common.PDDestinationOrAction;
import dev.wfj.gwtpdfbox.pdmodel.common.PDMetadata;
import dev.wfj.gwtpdfbox.pdmodel.common.PDPageLabels;
import dev.wfj.gwtpdfbox.pdmodel.documentinterchange.logicalstructure.PDStructureTreeRoot;
import dev.wfj.gwtpdfbox.pdmodel.graphics.optionalcontent.PDOptionalContentProperties;
import dev.wfj.gwtpdfbox.pdmodel.interactive.action.PDActionFactory;
import dev.wfj.gwtpdfbox.pdmodel.interactive.action.PDDocumentCatalogAdditionalActions;
import dev.wfj.gwtpdfbox.pdmodel.interactive.action.PDURIDictionary;
import dev.wfj.gwtpdfbox.pdmodel.interactive.documentnavigation.destination.PDDestination;
import dev.wfj.gwtpdfbox.pdmodel.interactive.documentnavigation.destination.PDNamedDestination;
import dev.wfj.gwtpdfbox.pdmodel.interactive.documentnavigation.destination.PDPageDestination;
import dev.wfj.gwtpdfbox.pdmodel.interactive.documentnavigation.outline.PDDocumentOutline;
import dev.wfj.gwtpdfbox.pdmodel.interactive.pagenavigation.PDThread;
import dev.wfj.gwtpdfbox.pdmodel.interactive.viewerpreferences.PDViewerPreferences;
...
{   
    ...
    /*public PDAcroForm getAcroForm(PDDocumentFixup acroFormFixup)
    {
        ...
        {
            DomGlobal.console.debug("AcroForm content has already been retrieved with fixes applied - original content changed because of that");
        }
    ...
    public PageMode getPageMode()
    {
        ...
        if (mode != null)
        {
            ...
            {
                DomGlobal.console.debug("Invalid PageMode used '" + mode + "' - setting to PageMode.USE_NONE", e);
    ...
    public PageLayout getPageLayout()
    {
        ...
        if (mode != null && !mode.isEmpty())
        {
            ...
            {
                DomGlobal.console.warn("Invalid PageLayout used '" + mode + "' - returning PageLayout.SINGLE_PAGE", e);
            }
        }
