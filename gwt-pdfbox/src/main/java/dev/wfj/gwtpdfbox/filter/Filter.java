...
public abstract class Filter
{
     ...
     */
    public static final String SYSPROP_DEFLATELEVEL = "dev.wfj.gwtpdfbox.filter.deflatelevel";
    ...
    protected COSDictionary getDecodeParams(COSDictionary dictionary, int index)
    {
        ...
        {
            DomGlobal.console.error("Expected DecodeParams to be an Array or Dictionary but found " +
    ...
    public static int getCompressionLevel()
    {
        ...
        {
            DomGlobal.console.warn(ex.getMessage(), ex);
        }*/
