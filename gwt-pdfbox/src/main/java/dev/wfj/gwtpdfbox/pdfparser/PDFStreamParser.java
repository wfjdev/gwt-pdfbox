...
public class PDFStreamParser extends BaseParser
{
            ...
            case 'B':
                ...
                if (nextOperator.equals(OperatorName.BEGIN_INLINE_IMAGE))
                {
                    ...
                    while( (nextToken = parseNextToken()) instanceof COSName )
                    {
                        ...
                        {
                            DomGlobal.console.warn("Unexpected token in inline image dictionary at offset " +
                                    source.getPosition());
                            break;
                        }
                    ...
                    if (nextToken instanceof Operator)
                    {
                        ...
                        {
                            DomGlobal.console.warn("empty inline image at stream offset " + source.getPosition());
                        }
    ...
    private boolean hasNoFollowingBinData() throws IOException
    {
        ...
        if (!noBinData)
        {
            DomGlobal.console.warn("ignoring 'EI' assumed to be in the middle of inline image at stream offset " + 
                    source.getPosition());
        }
        return noBinData;
    }
