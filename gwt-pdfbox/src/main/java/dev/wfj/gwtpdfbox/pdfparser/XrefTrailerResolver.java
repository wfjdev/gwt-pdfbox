...
public class XrefTrailerResolver
{
    ...
    public void setXRef( COSObjectKey objKey, long offset )
    {
        ...
        {
            // should not happen...
            DomGlobal.console.warn( "Cannot add XRef entry for '" + objKey.getNumber() + "' because XRef start was not signalled." );
            return;
        }
    ...
    public void setTrailer( COSDictionary trailer )
    {
        ...
        {
            // should not happen...
            DomGlobal.console.warn( "Cannot add trailer because XRef start was not signalled." );
            return;
        }
    ...
    public void setStartxref( long startxrefBytePosValue )
    {
        ...
        {
            DomGlobal.console.warn( "Method must be called only ones with last startxref value." );
            return;
        }
        ...
        if ( curObj == null )
        {
            ...
            DomGlobal.console.warn( "Did not found XRef object at specified startxref position " + startxrefBytePosValue );
        ...
        else
        {
            ...
            while ( curObj.trailer != null )
            {
                ...
                if ( curObj == null )
                {
                    DomGlobal.console.warn( "Did not found XRef object pointed to by 'Prev' key at position " + prevBytePos );
                    break;
                }
