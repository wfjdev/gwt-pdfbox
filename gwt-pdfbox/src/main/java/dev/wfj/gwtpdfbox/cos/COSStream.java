...
import dev.wfj.gwtpdfbox.filter.DecodeOptions;
import dev.wfj.gwtpdfbox.filter.Filter;
import dev.wfj.gwtpdfbox.filter.FilterFactory;
import dev.wfj.gwtpdfbox.io.IOUtils;
import dev.wfj.gwtpdfbox.io.RandomAccess;
import dev.wfj.gwtpdfbox.io.RandomAccessInputStream;
import dev.wfj.gwtpdfbox.io.RandomAccessOutputStream;
...
import dev.wfj.gwtpdfbox.io.RandomAccessStreamCache;
...
public class COSStream extends COSDictionary implements Closeable
{
    ...
    public String toTextString()
    {
        ...
        {
            DomGlobal.console.debug("An exception occurred trying to get the content - returning empty string instead", e);
            return "";
        }
    }
