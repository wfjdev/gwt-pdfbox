...
import dev.wfj.gwtpdfbox.cos.ICOSVisitor;
...
import dev.wfj.gwtpdfbox.pdfparser.xref.FreeXReference;
import dev.wfj.gwtpdfbox.pdfparser.xref.NormalXReference;
import dev.wfj.gwtpdfbox.pdfparser.xref.ObjectStreamXReference;
...
public class COSWriter implements ICOSVisitor
{
    ...
    private final Map<COSBase,COSObjectKey> objectKeys = new HashMap<>();
