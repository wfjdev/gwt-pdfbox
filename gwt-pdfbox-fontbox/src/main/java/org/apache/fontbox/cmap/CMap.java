...
public class CMap
{
    ...
    public String toUnicode(int code, int length)
    {
        ...
        DomGlobal.console.warn("Mappings with more than 2 bytes aren't supported");
        return null;
    }
    ...
    public int readCode(InputStream in) throws IOException
    {
        ...
        {
            DomGlobal.console.warn("mark() and reset() not supported, " + (maxCodeLength - 1) +
    ...
    {
        unicodeToByteCodes.put(unicode, Arrays.copyOf(codes, codes.length)); // clone needed, bytes is modified later
        ...
        {
            DomGlobal.console.warn("Mappings with more than 2 bytes aren't supported yet");
        }
