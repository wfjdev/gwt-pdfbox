...
public class KerningSubtable
{
    ...
    public int[] getKerning(int[] glyphs)
    {
        ...
        {
            DomGlobal.console.warn("No kerning subtable data available due to an unsupported kerning subtable version");
        }
        return kerning;
    }
    ...
    private void readSubtable0(TTFDataStream data) throws IOException
    {
        ...
        if (version != 0)
        {
            DomGlobal.console.info("Unsupported kerning sub-table version: " + version);
            return;
        }
        ...
        {
            DomGlobal.console.debug("Skipped kerning subtable due to an unsupported kerning subtable version: " + format);
        }
    }
    ...
    {
        DomGlobal.console.info("Kerning subtable format 2 not yet supported.");
    }

    private void readSubtable1(TTFDataStream data)
    {
        DomGlobal.console.info("Kerning subtable format 1 not yet supported.");
    }
