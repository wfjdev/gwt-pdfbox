...
import dev.wfj.gwtpdfbox.fontbox.ttf.model.ScriptFeature;
...
public class GsubWorkerForBengali implements GsubWorker
{
    ...
    public List<Integer> applyTransforms(List<Integer> originalGlyphIds)
    {
        ...
        for (String feature : FEATURES_IN_ORDER)
        {
            ...
            {
                DomGlobal.console.debug("the feature " + feature + " was not found");
                continue;
            }

            DomGlobal.console.debug("applying the feature " + feature);
            ...
            List<Integer> originalGlyphs)
    {
        ...
        DomGlobal.console.debug("originalGlyphs: " + originalGlyphs + ", gsubProcessedGlyphs: "
                + gsubProcessedGlyphs);
