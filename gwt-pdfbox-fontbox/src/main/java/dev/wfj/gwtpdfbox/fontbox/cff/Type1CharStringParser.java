...
public class Type1CharStringParser
{
    ...
    private void processCallSubr(List<byte[]> subrs, List<Object> sequence) throws IOException
    {
        ...
        {
            DomGlobal.console.warn("Parameter " + obj + " for CALLSUBR is ignored, integer expected in glyph '"
        ...
        {
            DomGlobal.console.warn("CALLSUBR is ignored, operand: " + operand + ", subrs.size(): " + subrs.size()
    ...
    private void processCallOtherSubr(DataInput input, List<Object> sequence) throws IOException
    {
        ...
        if (!results.isEmpty())
        {
            DomGlobal.console.warn("Value left on the PostScript stack in glyph " + currentGlyph + " of font "
                    + fontName);
        }
    }
