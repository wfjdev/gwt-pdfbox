...
package dev.wfj.gwtpdfbox.fontbox.util.autodetect;
        ...
        for (File file : filelist)
        {
            if (file.isDirectory())
            {
                ...
                if (file.isHidden())
                {
                    ...
                    {
                        DomGlobal.console.debug("skip hidden directory " + file);
                    }*/
                    continue;
                }
                walk(file, results);
            ...
            else
            {
                /*if (DomGlobal.isDebugEnabled())
                {
                    DomGlobal.console.debug("checkFontfile check " + file);
                }*/
                if (checkFontfile(file))
                {
                    /*if (DomGlobal.isDebugEnabled())
                    {
                        DomGlobal.console.debug("checkFontfile found " + file);
                    }*/
