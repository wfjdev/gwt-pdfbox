...
package dev.wfj.gwtpdfbox.fontbox.ttf.table.gsub;
...
public class LookupTypeSingleSubstFormat2 extends LookupSubTable
{
    ...
    {
        return null;// "LookupTypeSingleSubstFormat2[substFormat=%d,substituteGlyphIDs=%s]", getSubstFormat(), Arrays.toString(substituteGlyphIDs));
    }
}