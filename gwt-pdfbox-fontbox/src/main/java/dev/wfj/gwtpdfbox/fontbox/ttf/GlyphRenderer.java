...
class GlyphRenderer
{
    ...
    private void moveTo(GeneralPath path, Point point)
    {
        ...
        /* if (DomGlobal.isDebugEnabled())
        {
            DomGlobal.trace("moveTo: " + String.format(Locale.US, "%d,%d", point.x, point.y));
        }*/
    }
    ...
    private void lineTo(GeneralPath path, Point point)
    {
        ...
        /*if (DomGlobal.isDebugEnabled())
        {
            DomGlobal.trace("lineTo: " + String.format(Locale.US, "%d,%d", point.x, point.y));
        }*/
    }
    ...
    private void quadTo(GeneralPath path, Point ctrlPoint, Point point)
    {
        ...
        /*if (DomGlobal.isDebugEnabled())
        {
            DomGlobal.trace("quadTo: " + String.format(Locale.US, "%d,%d %d,%d", ctrlPoint.x, ctrlPoint.y,
                    point.x, point.y));
        }*/
    }
