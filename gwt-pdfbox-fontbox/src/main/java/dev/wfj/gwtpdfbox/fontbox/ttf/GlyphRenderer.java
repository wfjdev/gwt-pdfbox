...
class GlyphRenderer
{
    ...
    private void moveTo(GeneralPath path, Point point)
    {
        ...
        {
            DomGlobal.trace("moveTo: " + Locale.US, "%d,%d", point.x, point.y));
        }*/
    }
    ...
    private void lineTo(GeneralPath path, Point point)
    {
        ...
        /*if (DomGlobal.isDebugEnabled())
        {
            DomGlobal.trace("lineTo: " + Locale.US, "%d,%d", point.x, point.y));
        }*/
    }
    ...
    private void quadTo(GeneralPath path, Point ctrlPoint, Point point)
    {
        ...
        /*if (DomGlobal.isDebugEnabled())
        {
            DomGlobal.trace("quadTo: " + Locale.US, "%d,%d %d,%d", ctrlPoint.x, ctrlPoint.y,
                    point.x, point.y));
        }*/
    }
